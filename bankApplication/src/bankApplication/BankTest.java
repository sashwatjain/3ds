package bankApplication;
	...
	public class BankTest {
		public static void main(String[] args) {
            ...
            BankAccount bankAcc3 = bank.applyForAJointAccount(bankAppForm1, bankAppForm2);
	...
	class Bank
	{
		...
		BankAccount applyForAJointAccount(BankApplicationForm bankAppFormRef1, BankApplicationForm bankAppFormRef2) {
			System.out.println("Recieved the application from  : "+bankAppFormRef1.getApplicantName() + " and " + bankAppFormRef2.getApplicantName());
